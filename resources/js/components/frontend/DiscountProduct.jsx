...
const DiscountProduct = () => {
    return (
        <>
            <div className="max-w-7xl mx-auto p-6 my-8 mt-14">
                {/* Section Header */}
                <div className="text-center mb-4">
                    <h2 className="text-4xl font-bold mb-4 capitalize">Hot Discount Product</h2>
                    <span className="bg-red-500 text-white px-3 py-1 rounded-full text-sm">SPRING 2025</span>
                </div>

                {/* Swiper Carousel */}
                <div className="py-9 w-[90%] mx-auto">
                    <Swiper
                        spaceBetween={20}
                        freeMode={true}
                        slidesPerView={4}
                    ...
                    >
                        ...
                        <SwiperSlide>
                            <div className="py-9">
                                <div className="hover_content relative group w-[260px] mx-auto">
                                    {/* Product Image */}
                                    <img
                                        src={NewCollection}
                                        alt="Kurti"
                                ...
                                <p className="text-center text-gray-600 mt-2">
                                    <span className="ml-2 text-black font-semibold mr-2">৳ 2350</span>
                                    <span className="line-through text-red-500">৳ 2500</span>
                                </p>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
